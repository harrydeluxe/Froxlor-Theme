$header
	...
	<article>
		...
		<section class="fullform bradiusodd">
			...
			<tr>
				<td class="main_field_confirm" colspan="2"><input type="hidden" name="send" value="send" /><input class="btn btn-success" type="submit" class="bottom" value="{$lng['panel']['search']}" /></td>
			</tr>
			</table>
